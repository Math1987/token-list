...
export var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongoose.createConnection(environment.db)];
            case 1:
                db = _a.sent();
                initUser(db);
                initSession(db);
 ...
 * @returns true
 */
export var reset = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, db.dropDatabase()];
            case 3:
                _a.sent();
                return [4 /*yield*/, db.syncIndexes()];
            case 4:
                _a.sent();
