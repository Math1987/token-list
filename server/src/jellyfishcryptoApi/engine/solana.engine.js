    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new Connection(clusterApiUrl(environment.solana.cluster))];
            case 1: return [2 /*return*/, connection = _a.sent()];
        }
    });
}); };
/**
 ...
 */
export var readSimpleTransferTransaction = function (signature) { return __awaiter(void 0, void 0, void 0, function () {
    var transac;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, connection.getTransaction(signature)];
            case 1:
                transac = _c.sent();
                return [2 /*return*/, {
                        ammount: (((_a = transac === null || transac === void 0 ? void 0 : transac.meta) === null || _a === void 0 ? void 0 : _a.postBalances[1]) - ((_b = transac === null || transac === void 0 ? void 0 : transac.meta) === null || _b === void 0 ? void 0 : _b.preBalances[1])) / LAMPORTS_PER_SOL,
...
export var readAddressFromTransaction = function (signature, time) {
    if (time === void 0) { time = environment.solana.transactions["default"].time; }
 ...
 * @returns
 */
export var readAndVerifySimpleTransferTransaction = function (signature, ammount, receiver, time) {
    if (ammount === void 0) { ammount = environment.solana.transactions["default"].ammount; }
    if (receiver === void 0) { receiver = environment.solana.transactions["default"].receiver; }
    if (time === void 0) { time = environment.solana.transactions["default"].time; }
    return __awaiter(void 0, void 0, void 0, function () {
        var transac;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, readSimpleTransferTransaction(signature)];
                case 1:
                    transac = _a.sent();
...
export var verifyMessage = function (address, signature, message) { return __awaiter(void 0, void 0, void 0, function () {
